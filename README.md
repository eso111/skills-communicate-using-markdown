...
1. In the Commit changes pop-up, notice a draft commit message. If needed, edit that message to ensure it is short, meaningful, and describes the change you made to the file.
